    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-8">
        ...
        <motion.div
          ...
          className="mb-10 bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-400 text-white 
            ...
            return (
              ...
              >
                <Card
                  isPressable
                  onPress={() => router.push(`/categories/${category.url}`)}
                  className="group rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 bg-white/90 backdrop-blur-sm"
                >
                  <CardBody className="p-0">
                    <div className="relative overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4">
                        <div
                          className="rounded-xl p-1 transition-all duration-300 group-hover:bg-white/10 group-hover:backdrop-blur-sm"
                          style={{
                            background:
